...
app = Flask('')
NAME='HOSTING_BOT'  #Add what ever you want to desplay in bot like , i am ____ hostin bot 
@app.route('/')
def home():
...
# --- Configuration ---
TOKEN = '8506734003:AAEICuOsi-CNVC60G7uMWb-Fvv9SCx6EMfk'
OWNER_ID = 8485798078 # ADD YOUR USER ID 
ADMIN_ID = 8485798078 # DON'T REPLACE IF REPLACE THEN BOT NOT WORKING 
YOUR_USERNAME = '@itzrdxking' # ADD YOUR USERNAME 
UPDATE_CHANNEL = '@RDXBIO8' # ADD YOUR YOU CHANNEL USERNAME 
